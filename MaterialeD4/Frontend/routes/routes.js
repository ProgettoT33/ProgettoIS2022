...
//API - OFFERENTE
router.get('/api/offerer', offererController.getAllOfferer);
router.post('/api/offerer', upload.none(), registrationoffererController.newOfferer);
router.delete('/api/offerer', offererController.deleteAllOfferer);
...
router.post('/api/offerer/idtelegram/:email', offererController.setIdTelegram);
router.post('/api/offerer/description/:email', offererController.setDescription);
router.post('/api/offerer/name/:email', offererController.setName);
router.post('/api/offerer/surname/:email', offererController.setSurname);
router.post('/api/offerer/password/:email', offererController.setPassword);
router.post('/api/offerer/:emailO', offererController.addRelatedStudents)

//API - ANNUNCIO
router.get('/api/announcement', announcementController.getAllAnnouncement);
router.post('/api/announcement', upload.none(), announcementController.newAnnouncement);
router.delete('/api/announcement', announcementController.deleteAllAnnouncement);
router.get('/api/announcement/:typeofwork', announcementController.getOneAnnouncement);
router.delete('/api/announcement/:typeofwork', announcementController.deleteOneAnnouncement);
